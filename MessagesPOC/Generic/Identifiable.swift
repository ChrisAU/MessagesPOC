...
extension UICollectionView {
    ...
    func registerHeader(_ viewClass: Identifiable.Type) {
        register(viewClass,
                 forSupplementaryViewOfKind: UICollectionElementKindSectionHeader,
                 withReuseIdentifier: viewClass.identifier)
    }
    
    func dequeueReusableHeader<T: Identifiable>(at indexPath: IndexPath) -> T {
        return dequeueReusableSupplementaryView(ofKind: UICollectionElementKindSectionHeader,
                                                withReuseIdentifier: T.identifier,
                                                for: indexPath) as! T
    }
    
    func registerFooter(_ viewClass: Identifiable.Type) {
        register(viewClass,
                 forSupplementaryViewOfKind: UICollectionElementKindSectionFooter,
                 withReuseIdentifier: viewClass.identifier)
    }
    
    func dequeueReusableFooter<T: Identifiable>(at indexPath: IndexPath) -> T {
